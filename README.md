...
Copyright (c) 2014-2018, The Ferro Project

## Development Resources

- Web: [ferro.cash](https://ferro.cash)
- Forum: [Bitcointalk.org](https://bitcointalk.org/index.php?topic=3203967.0)
- Mail: [support@ferro.cash](mailto:support@ferro.cash)

## Vulnerability Response

- Our [Vulnerability Response Process](https://github.com/ferro-project/meta/blob/master/VULNERABILITY_RESPONSE_PROCESS.md) encourages responsible disclosure
- We are also available via [HackerOne](https://hackerone.com/ferro)
...
This is the GUI for the [core Ferro implementation](https://github.com/ferro-project/ferro). It is open source and completely free to use without restrictions, except for those specified in the license agreement below. There are no restrictions on anyone creating an alternative implementation of Ferro that uses the protocol and network in a compatible manner.
...
2. Grab an up-to-date copy of the ferro-core repository
...
3. Install [ferro](https://github.com/ferro-project/ferro) dependencies:
...
6. Grab an up-to-date copy of the ferro-core repository
...
2. Install ferro dependencies as described in [ferro documentation](https://github.com/ferro-project/ferro) into msys2 environment
