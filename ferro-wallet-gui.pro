...
WALLET_ROOT=$$PWD/ferro

CONFIG += c++11

# cleaning "auto-generated" bitferro directory on "make distclean"
...
linux {
   ...
   #     }
    ...
    # currently ferro has an issue with "static" build and linunwind-dev,
...
TRANSLATIONS =  \ # English is default language, no explicit translation file
                $$PWD/translations/ferro-core.ts \ # translation source (copy this file when creating a new translation)
                $$PWD/translations/ferro-core_ar.ts \ # Arabic
                $$PWD/translations/ferro-core_pt-br.ts \ # Portuguese (Brazil)
                $$PWD/translations/ferro-core_de.ts \ # German
                $$PWD/translations/ferro-core_eo.ts \ # Esperanto
                $$PWD/translations/ferro-core_es.ts \ # Spanish
                $$PWD/translations/ferro-core_fi.ts \ # Finnish
                $$PWD/translations/ferro-core_fr.ts \ # French
                $$PWD/translations/ferro-core_hr.ts \ # Croatian
                $$PWD/translations/ferro-core_id.ts \ # Indonesian
                $$PWD/translations/ferro-core_hi.ts \ # Hindi
                $$PWD/translations/ferro-core_it.ts \ # Italian
                $$PWD/translations/ferro-core_ja.ts \ # Japanese
                $$PWD/translations/ferro-core_nl.ts \ # Dutch
                $$PWD/translations/ferro-core_pl.ts \ # Polish
                $$PWD/translations/ferro-core_ru.ts \ # Russian
                $$PWD/translations/ferro-core_sv.ts \ # Swedish
                $$PWD/translations/ferro-core_zh-cn.ts \ # Chinese (Simplified-China)
                $$PWD/translations/ferro-core_zh-tw.ts \ # Chinese (Traditional-Taiwan)
                $$PWD/translations/ferro-core_he.ts \ # Hebrew
                $$PWD/translations/ferro-core_ko.ts \ # Korean
                $$PWD/translations/ferro-core_ro.ts \ # Romanian
...
android{
    deploy.commands += make install INSTALL_ROOT=$$DESTDIR && androiddeployqt --input android-libferro-wallet-gui.so-deployment-settings.json --output $$DESTDIR --deployment bundled --android-platform android-21 --jdk /usr/lib/jvm/java-8-openjdk-amd64 -qmldir=$$PWD
}
...
DISTFILES += \
    notes.txt \
    ferro/src/wallet/CMakeLists.txt \
    components/MobileHeader.qml


# windows application icon
RC_FILE = ferro-core.rc
