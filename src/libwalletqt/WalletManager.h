...
public:
    enum LogLevel {
        LogLevel_Silent = Ferro::WalletManagerFactory::LogLevel_Silent,
        LogLevel_0 = Ferro::WalletManagerFactory::LogLevel_0,
        LogLevel_1 = Ferro::WalletManagerFactory::LogLevel_1,
        LogLevel_2 = Ferro::WalletManagerFactory::LogLevel_2,
        LogLevel_3 = Ferro::WalletManagerFactory::LogLevel_3,
        LogLevel_4 = Ferro::WalletManagerFactory::LogLevel_4,
        LogLevel_Min = Ferro::WalletManagerFactory::LogLevel_Min,
        LogLevel_Max = Ferro::WalletManagerFactory::LogLevel_Max,
    };
