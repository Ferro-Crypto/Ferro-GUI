...
#include "wallet/wallet2_api.h" // we need to have an access to the Ferro::Wallet::Status enum here;
...
public:
    ...
    enum Status {
        Status_Ok       = Ferro::Wallet::Status_Ok,
        Status_Error    = Ferro::Wallet::Status_Error,
        Status_Critical = Ferro::Wallet::Status_Critical
    };

    Q_ENUM(Status)

    enum ConnectionStatus {
        ConnectionStatus_Connected       = Ferro::Wallet::ConnectionStatus_Connected,
        ConnectionStatus_Disconnected    = Ferro::Wallet::ConnectionStatus_Disconnected,
        ConnectionStatus_WrongVersion    = Ferro::Wallet::ConnectionStatus_WrongVersion
    };
...
private:
    ...
    Wallet(Ferro::Wallet *w, QObject * parent = 0);
    ~Wallet();
private:
    friend class WalletManager;
    friend class WalletListenerImpl;
    //! libwallet's
    Ferro::Wallet * m_walletImpl;
