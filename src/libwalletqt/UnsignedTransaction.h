...
public:
    enum Status {
        Status_Ok       = Ferro::UnsignedTransaction::Status_Ok,
        Status_Error    = Ferro::UnsignedTransaction::Status_Error,
        Status_Critical    = Ferro::UnsignedTransaction::Status_Critical
    };
    Q_ENUM(Status)

    enum Priority {
        Priority_Low    = Ferro::UnsignedTransaction::Priority_Low,
        Priority_Medium = Ferro::UnsignedTransaction::Priority_Medium,
        Priority_High   = Ferro::UnsignedTransaction::Priority_High
    };
    Q_ENUM(Priority)
...
private:
    explicit UnsignedTransaction(Ferro::UnsignedTransaction * pt, Ferro::Wallet *walletImpl, QObject *parent = 0);
    ~UnsignedTransaction();
private:
    friend class Wallet;
    Ferro::UnsignedTransaction * m_pimpl;
    QString m_fileName;
