...
public:
    enum Direction {
        Direction_In  =  Ferro::TransactionInfo::Direction_In,
        Direction_Out =  Ferro::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Ferro::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Ferro::TransactionInfo * m_pimpl;
