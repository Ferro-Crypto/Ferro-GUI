...
AddressBook::AddressBook(Ferro::AddressBook *abImpl,QObject *parent)
...
QList<Ferro::AddressBookRow*> AddressBook::getAll(bool update) const
{
    qDebug(__FUNCTION__);
...
Ferro::AddressBookRow * AddressBook::getRow(int index) const
{
